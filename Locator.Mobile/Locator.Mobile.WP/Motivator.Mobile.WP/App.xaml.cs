...
using Motivator.Mobile.BL.Request;
using Motivator.Mobile.BL.ServiceClient;
using Motivator.Mobile.Client;
using Motivator.Mobile.Presentation;
using Motivator.Mobile.WP.Helpers;
...
namespace Motivator.Mobile.WP
{
    ...
    {
        private const string MotivatorTaskName = "Motivator";
        private const string MotivatorTaskDesc = "Motivator task";
        public const double MaxDistanceMeters = 100;
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            TaskHelper.RegisterPeriodicTask(MotivatorTaskName, MotivatorTaskDesc);
            OpenPushChannel();
		}
        ...
        private void RegisterComponents(TinyIoCContainer container)
        {
            ...
            container.Register<IMemoriesView, MemoriesViewModel>();
            container.Register<IMemoryTaskView, MemoryTaskViewModel>();
        }

        #region PushNotification
        private void OpenPushChannel()
        {
            const string channelName = "MotivatorChannel";
